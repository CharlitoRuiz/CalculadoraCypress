...
describe('Hacer operaciones en la calculadora', () => {
  ...
  beforeEach("Ingresar a la pagina", ()=>{
    ...
    cy.fixture('datos').then((datos) => {
      let numeroA = datos.numero1,
      numeroB = datos.numero2,
      operacion = datos.operacion,
      numeroAI = datos.numeroAI,
      numeroBI = datos.numeroBI
  ...
  it.only('Sumar dos numeros', () => {
    cy.fixture('datos').then((datos) => {
      calculadora.seleccionarOperacion('Add')
      calculadora.clickBtnCalcular();
      resultado_operacion = datos.numero1 + datos.numero2;
    })
  })
...
it('Hacer las operaciones completas iterando numeros', () => {
